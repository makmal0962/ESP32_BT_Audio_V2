...
//OLED display config
#define APP_DISPLAY_I2C_SDA_GPIO      CONFIG_DISPLAY_I2C_SDA_GPIO
#define APP_DISPLAY_I2C_SCL_GPIO      CONFIG_DISPLAY_I2C_SCL_GPIO

//physical buttons config
#define APP_BTN_PREV_GPIO             CONFIG_BTN_PREV_GPIO
#define APP_BTN_PLAY_GPIO             CONFIG_BTN_PLAY_GPIO
#define APP_BTN_NEXT_GPIO             CONFIG_BTN_NEXT_GPIO
#define APP_BTN_MODE_GPIO             CONFIG_BTN_MODE_GPIO

// Line input config
#define APP_LINE_IN_RELAY_GPIO  CONFIG_LINE_IN_RELAY_GPIO
#define APP_LINE_IN_ADC_GPIO    CONFIG_LINE_IN_ADC_GPIO
